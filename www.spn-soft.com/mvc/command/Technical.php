<?php
	...
	class Technical extends Command{
		function doExecute( \MVC\Controller\Request $request ) {
			...
			//THAM SỐ GỬI ĐẾN
			//-------------------------------------------------------------
			$IdTechnical = $request->getProperty('IdTechnical');
			...
			$Technical = $mTechnical->find($IdTechnical);
			...
			$request->setObject("Technical", $Technical);
			...
			$request->setProperty("ActiveItem", 'Technical');
