...
class VideoMonk extends Mapper implements \MVC\Domain\VideoMonkFinder {
    ...
    function __construct() {
		...
		$tblVideoMonk = "chuavinhkhanh_video_monk";
		...
		$findByTopLocalStmt = sprintf("select *  from %s VM order by (select time from %s V where V.id=VM.id_video ) DESC limit 8", $tblVideoMonk, $tblVideo);
