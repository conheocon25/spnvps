...
-->
</style><input type="button" value="Thêm mới" name="btnNew" onclick="window.location='./?act=albumvideo_them'" class="button"><table border="1" cellpadding="2" bordercolor="#C9C9C9" width="100%">
	<tr>
...
<?php 							
require '../config.php';
$sql="select*from  theloaialbumvideo tl,albumvideo al where tl.id=al.idtheloai  order by al.id desc";
$kq=mysql_query($sql);
...
$theloai=$row["theloai"]; ?>
<tr>
		<th width="20"><a onClick="return confirm('Bạn có chắc chắn muốn xóa ?');"  href="?act=albumvideo_del&id=<?php echo $id ?>">Xóa</a></th>
		<th width="20"><a href="?act=albumvideo_cs&id=<?php echo $id ?>">Sửa</a></th>
