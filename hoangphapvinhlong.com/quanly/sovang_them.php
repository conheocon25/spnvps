...
<form name="f1" action="?act=sovang_them&lenh=do" method="post" enctype="multipart/form-data">
...
//Check MIME Type  
   ...
   echo "Name: $name<br/ >Type: $type<br />Size: $size<br />Tmp: $tmp";               
    ...
    $them=mysql_query("insert into sovang(`title`,`img`,`published`,`fulltext`,`created`,`created_by`,`hits`,`link`)VALUES('{$tieude}','{$duongdan}','{$congbo}','{$noidung}','{$created}','{$created_by}','{$hits}','{$kd}')"); 
