...
<form name="f1" action="?act=phanloai_them&lenh=do" method="post" enctype="multipart/form-data">
...
$published=$_POST["published"];
     ...
     $them=mysql_query("insert into video_phanloai(`tenloai`,`hienthi`)VALUES('{$name}','{$published}')"); 
