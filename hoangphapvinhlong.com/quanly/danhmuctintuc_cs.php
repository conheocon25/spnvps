...
require '../config.php';
$a=$_GET["id"];
 $dulieu_sua="select*from content_categories where id = '$a'";
...
<form name="f1" action="?act=danhmuctintuc_cs&lenh=do" method="post" enctype="multipart/form-data">
...
$name=$_POST["name"];
    ...
    $them=mysql_query("update `content_categories` set `name`='$name',`published`='$published' where `id`='$id'"); 
