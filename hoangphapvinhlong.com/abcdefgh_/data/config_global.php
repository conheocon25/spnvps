 ...
 * @Createdate Sat, 23 Aug 2014 13:49:03 GMT
 */
...
$global_config['error_send_email'] = "hoangvinh4686@yahoo.com";
$global_config['file_allowed_ext'] = "adobe,application,archives,audio,documents,flash,images,real,text,video,xml";
...
$global_config['gfx_chk'] = 7;
$global_config['googleAnalyticsID'] = "UA-46093692-5";
...
$global_config['my_domains'] = "localhost,luongiongvinhlong.com";
$global_config['nv_max_size'] = 16777216;
$global_config['online_upd'] = 1;
$global_config['openid_mode'] = 0;
$global_config['openid_servers'] = "nukeviet";
...
$global_config['session_prefix'] = "nv3s_Ix8mjj";
$global_config['site_email'] = "hoangvinh64@gmail.com";
$global_config['site_keywords'] = "NukeViet, portal, mysql, php, opensource cms, FOSS Vietnam";
...
$global_config['upload_logo'] = "images&#x002F;logo.png";
$global_config['useactivate'] = 2;
$global_config['version'] = "3.4.02";
$global_config['whoviewuser'] = 1;
