...
require'ketnoi.php';						
$sql="select*from video_video vi,video_categories ca,video_phanloai pl,tinhthanh tt where pl.maloai=ca.phanloai and ca.id=vi.category and vi.category='$a2' and vi.congbo=1 and ca.congbo=1 and tt.matinh=ca.tinhthanh";
$kq=mysql_query($sql);
...
$row2=mysql_fetch_row($count2);
					...
					?>
						...
						<div class="inner details-ct">
        <div class="detail-info">
            <div class="col-1" align="center">
                <span class="img-box"><img src="<?php echo $img ?>" alt="<?php echo $name ?>" height="195px" width="150px"/></span>
            </div>
            <div class="col-2">
                <h1 class="dt-name"><?php echo $name ?></h1>
				<h6>Tỉnh thành: <?php echo $tentinh ?></h6>
                <div class="dt-intro">
                    <h6>Giới Thiệu</h6>
                    <div style="height: 42px; overflow: hidden;" id="wrapcontent">
                        <?php echo $gioithieu?>
						</div>
                    <div class="dt-bt">
                        <a id="contentmore" title="Xem thêm" data-toggle="collapse" data-parent="#accordion2" href="#wrapcontent" class="btn-viewmore"><span>Xem thêm/ Rút gọn</span></a>
...
<div class="b-content news-content padding-content">
						<div class="news-author monk-author"><p>
								<span class="btn btn-danger disabled btn-small">
									<i class="icon-tags icon-white"></i> Video của giang sư
								</span>
							</p></div></div>
						<div class="b-content news-content padding-content">
						<?php 
...
$sodu_lieu = mysql_num_rows(mysql_query("select*from video_categories ca,video_video vi where ca.id=vi.category and ca.congbo=1 and vi.category='$a2' and vi.congbo=1 order by vi.id desc") ) or die(mysql_error());
$sotrang = $sodu_lieu/$baitren_mottrang;
$huuha=$page*$baitren_mottrang;
$result =mysql_query("select*from video_categories ca,video_video vi where ca.id=vi.category and ca.congbo=1 and vi.category='$a2' and vi.congbo=1 order by vi.id desc LIMIT {$huuha},{$baitren_mottrang} ") or die(mysql_error());
