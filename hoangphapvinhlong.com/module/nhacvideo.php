              ...
              <div id="collapseOne" class="accordion-body collapse in b-content">
                <div class="carousel slide carousel-fade img-polaroid news-slide">
                  <div class="carousel-inner">
                    <?php  require './ketnoi.php'; $sql="select * from albumvideo al,theloaialbumvideo tl where tl.id=al.idtheloai and al.noibac=1 order by al.id desc";
												$kq=mysql_query($sql);
												if(mysql_num_rows($kq)!=0)
												{
												$i=0;
                    ...
                    <div class="item active">
                      <a href="xem-album<?php echo $id ?>-<?php echo $linkal ?>">
					...
					<div class="box radius">
						...
						<?php 
 require './ketnoi.php';
 $sql="select*from albumvideo order by id desc limit 1";
$kq=mysql_query($sql);
...
$hinh=$row["hinh"];
 ...
 ?>
    ...
    <form method="POST" action="index.php?frame=nhacvideo&act=do" name="f1" onSubmit="return kiemtra();">
 ...
 require './ketnoi.php';
$sql2="select*from albumvideo al,theloaialbumvideo tl where tl.id=al.idtheloai order by al.id desc limit 30";
$kq2=mysql_query($sql2);
  if(mysql_num_rows($kq2)!=0)
					...
					?>
							...
							<ul class="thumbnails grid-item-2 reset-margin"><?php 
 require './ketnoi.php';
$sql2="select*from albumvideo al,theloaialbumvideo tl where tl.id=al.idtheloai  order by al.luotxem desc limit 30";
$kq2=mysql_query($sql2);
  if(mysql_num_rows($kq2)!=0)
                                            {
                                                while($row2=mysql_fetch_array($kq2))
