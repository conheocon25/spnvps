<div class="span8 fix-width">
					...
					<div class="box radius">
						<div class="b-title">
							<div class="b-t-icon-content">Thông báo</div>
						</div>
...
while ( $row = mysql_fetch_array($result )) 
{
										...
										?>
										 <div class="media img-polaroid new-list-polaroid">
										   <a class="pull-left" href="thong-bao-chi-tiet<?php echo $id ?>">
								...
								<div class="media-body">
									...
									<p class="media-reduce"><?php echo mb_substr($noidung,0,300,'UTF-8');echo "..."; ?></p>
										<a class="btn btn-info" href="thong-bao-chi-tiet<?php echo $id ?>"> Xem chi tiết</a>
								</div>
							</div>
   <?php
}}
...
?>
											...
											<a href='?frame=thongbao&id=<?php echo $a ?>&page=<?php echo $page ?>'> <?php echo $page ?></a>
