...
class EventImage extends Object{
	...
	function setIdImage( $IdImage ) {$this->IdImage = $IdImage;$this->markDirty();}   
	function getIdImage( ) {return $this->IdImage;}	
	...
	function toXML(){
		...
		<object>
			...
			<id_image>".$this->getIdImage()."</id_image>
