...
class VideoLibrary extends Object{
	...
	//-------------------------------------------------------------------------------
    function __construct( $Id=null, $IdVideo=null, $IdCategory=null){
        $this->Id = $Id;
	...
	//-------------------------------------------------------------------------------		
	function getURLView(){
		return "/library/category/video/".$this->getIdCategory()."/".$this->getId();
	}
	...
	function getURLDelLoad(){		
		return "/app/category/video/".$this->getIdCategory()."/".$this->getId()."/del/load";
	}
	function getURLDelExe(){
		return "/app/category/video/".$this->getIdCategory()."/".$this->getId()."/del/exe";
	}
