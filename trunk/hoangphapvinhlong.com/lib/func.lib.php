...
function mail_smtp($from,$to,$subject,$body,$html=0){
	...
	$smtp->pop3_auth_host="gmail.com";           /* Set to the POP3 authentication host if your SMTP server requires prior POP3 authentication */
	$smtp->user="hoangvinh64@gmail.com";                     /* Set to the user name if the server requires authetication */
