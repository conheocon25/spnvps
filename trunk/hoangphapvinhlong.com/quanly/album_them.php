...
<form name="f1" action="?act=album_them&lenh=do" method="post" enctype="multipart/form-data">
<tr><td>Tên danh mục : </td><td><textarea name="ten" cols="100" rows=""></textarea></td></tr>
<tr><td>Mô tả : </td><td><textarea name="mota" cols="100" rows=""></textarea></td></tr>
<tr>
  <td>Thuộc danh mục: </td>
  <td><select name="chuyenmuc">
   <?php 							
require '../config.php';
$sql="select*from  theloaialbum";
$kq=mysql_query($sql);
...
//Check MIME Type  
   ...
   echo "Name: $name<br/ >Type: $type<br />Size: $size<br />Tmp: $tmp";               
	 ...
	 $them=mysql_query("insert into  album(`ten`,`hinhbg`,`idtheloai`,`linkal`,`noibac`,`mota`,`luotxem`)VALUES('{$ten}','{$duongdan}','{$chuyenmuc}','{$kd}','{$noibac}','{$mota}','{$luotxem}')"); 
