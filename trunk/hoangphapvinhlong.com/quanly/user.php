...
-->
</style><input type="button" value="Thêm mới" name="btnNew" onclick="window.location='./?act=user_them'" class="button"><table border="1" cellpadding="2" bordercolor="#C9C9C9" width="100%">
	<tr>
...
<tr bgcolor="#CCCCCC" height="50px">
		<th width="20"><a onClick="return confirm('Bạn có chắc chắn muốn xóa ?');"  href="?act=user_del&id=<?php echo $id ?>">Xóa</a></th>
		<th width="20"><a href="?act=user_cs&id=<?php echo $id ?>">Sửa</a></th>
...
?>
											...
											<a href='?act=user&page=<?php echo $page ?>'> <?php echo $page ?></a>
