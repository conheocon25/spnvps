...
<form name="f1" action="?act=sidletrangchu_them&lenh=do" method="post" enctype="multipart/form-data">
...
//Check MIME Type  
   ...
   echo "Name: $name<br/ >Type: $type<br />Size: $size<br />Tmp: $tmp";               
    ...
    $them=mysql_query("insert into `sidletrangchu`(`tieudeside`,`noidungside`,`hinhanhside`,`linkside`)VALUES('{$tieude}','{$noidung}','{$duongdan}','{$link}')"); 
