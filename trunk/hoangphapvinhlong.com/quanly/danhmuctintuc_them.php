...
<form name="f1" action="?act=danhmuctintuc_them&lenh=do" method="post" enctype="multipart/form-data">
...
$published=$_POST["published"];
     ...
     $them=mysql_query("insert into content_categories(`name`,`published`)VALUES('{$name}','{$published}')"); 
