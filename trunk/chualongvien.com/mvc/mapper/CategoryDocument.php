...
class CategoryDocument extends Mapper implements \MVC\Domain\CategoryDocumentFinder{

    function __construct() {
        parent::__construct();
				
		$tblCategory = "chualongvien_category_document";
    ...
    function getCollection( array $raw ) {
        return new CategoryDocumentCollection( $raw, $this );
    }

    protected function doCreateObject( array $array ) {
        $obj = new \MVC\Domain\CategoryDocument( 
			$array['id'],
			$array['name'],
			$array['order'],
			$array['key']
    ...
    protected function targetClass() { return "CategoryDocument";}
	...
	function findByPage( $values ) {		
        ...
        return new CategoryDocumentCollection( $this->findByPageStmt->fetchAll(), $this );
    }
}
?>