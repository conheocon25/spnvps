...
class CourseClass extends Mapper implements \MVC\Domain\CourseClassFinder {
    ...
    function __construct() {
		...
		$tblCourseClass = "chuagiacquang_course_class";
		...
		$findByCourseStmt = sprintf("select *  from %s where id_course=?", $tblCourseClass);
		$findByMonkStmt = sprintf("select *  from %s where id_monk=?", $tblCourseClass);
