...
class ClassLession extends Mapper implements \MVC\Domain\ClassLessionFinder {
    ...
    function __construct() {
		...
		$tblClassLession = "chuagiacquang_class_lession";
		...
		$findByClassStmt = sprintf("select *  from %s where id_class=?", $tblClassLession);
		$findByMonkStmt = sprintf("select *  from %s where id_monk=?", $tblClassLession);
